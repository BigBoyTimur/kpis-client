...
export const AssignExperts = () => {
        ...
        return employeesToMetricsData.map((item) => {
            ...
            const enrichedMetrics = item.metrics_id.map((metricId) => {
                ...
                return {
                    ...
                    description: metric?.description || 'Описание отсутствует', // Используем строку по умолчанию
                };
            });

            return {
                ...item,
                employeeName: employee ? `${employee.last_name} ${employee.first_name} ${employee.surname}` : 'Неизвестный сотрудник',
    ...
    return (
        <div className="space-y-8">
            ...
            <AssignExpertsForm onSuccess={updateEmployeesToMetrics} />
